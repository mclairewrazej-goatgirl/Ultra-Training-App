          ...
          {selectedActivities.map(act => (
            <View key={act.id} style={[styles.actRow, { borderLeftColor: actColors[act.actType] }]}>
              ...
              <Text style={styles.actDetail}>
                {['dist','dur'].map(k => Number((act as any)[k]) > 0
    ...
    <Modal visible animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
      <View style={styles.modalContainer}>
        ...
        <ScrollView contentContainerStyle={styles.modalContent}>
          ...
          <View style={styles.dateBox}><Text style={styles.dateBoxText}>{date}</Text></View>
          ...
          <TextInput style={styles.input} value={desc} onChangeText={setDesc}
            placeholder="e.g. 12km easy + strides, 10×400m @ 5k pace"
          ...
          <View style={styles.row}>
            <View style={{ flex: 1 }}>
              ...
              <TextInput style={styles.input} value={dist} onChangeText={setDist}
                keyboardType="decimal-pad" placeholderTextColor={colors.muted2} placeholder="0" />
            </View>
            <View style={{ width: 12 }} />
            <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  dayHeader: { flex: 1, textAlign: 'center', fontSize: 11, color: colors.muted, fontWeight: '600', paddingVertical: 6 },

  grid: { flexDirection: 'row', flexWrap: 'wrap' },
  cell: {
    width: '14.285%', aspectRatio: 1, alignItems: 'center', justifyContent: 'center',
  ...
  dateBoxText: { color: colors.text, fontSize: 15 },
